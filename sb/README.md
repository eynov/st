...
> 部署到新主机前请先阅读[已知限制](docs/internal/KNOWN_LIMITATIONS.md)：其中列出了本项目
> 已在真实主机验证的范围，以及尚未验证的边界。
...
- 核心：固定 sing-box `1.13.16`，按架构校验 SHA256
...
VLESS 只实现三个经过固定 sing-box `1.13.16` 检查的模式，不提供其他 transport 或
参数组合：
...
- [维护记录与验证入口](docs/internal/AI_HANDOFF.md)
